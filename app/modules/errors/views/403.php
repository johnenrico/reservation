    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class="ex-page-content text-center">
                ...
                <a class="btn btn-purple waves-effect waves-light" href="<?php echo site_url(); ?>"><i class="fa fa-angle-left"></i> Back to Dashboard</a>
            </div>
        </div>
...
<html>
    ...
    <body>
        ...
        <div class="wrapper-page">
              <div class="ex-page-content text-center">
                <h1>403!</h1>
                <h2>Sorry, You don't have any Rights to Access this Module</h2><br>
                <a class="btn btn-purple waves-effect waves-light" href="<?php echo site_url(); ?>"><i class="fa fa-angle-left"></i> Back to Dashboard</a>
            </div>
        </div>
